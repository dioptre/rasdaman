...
public class RasdamanUtils
{
	...
	public void init() throws WCSException
	{
		...
		{
//          e.printStackTrace();
			throw new WCSException("RasdamanUnavailable",
	...
	public void insertGrayImageAsArray(String name, BufferedImage img) throws ODMGException
	{
		try
		{
			log("Creating grey image ...");
...
//      commitAndClose();
	...
	public RasGMArray createMddFromImage(BufferedImage img) throws RasResultIsNoIntervalException
	{
		int cols = img.getWidth();
		int rows = img.getHeight();
		// create 2-D MDD with cell length 1, i.e., type “byte”:
		String interval = "[1:" + cols + ",1:" + rows + "]";
		int cellType = 1;
