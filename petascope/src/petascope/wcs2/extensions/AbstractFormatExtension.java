...
public abstract class AbstractFormatExtension implements FormatExtension {
    ...
    protected void setBounds(GetCoverageRequest request, GetCoverageMetadata m, DbMetadataSource meta) throws WCSException {
        Pair<byte[], String> pair = executeRasqlQuery(request, m, meta, "sdom", null);
        Pair<String, String> bounds = WcsUtil.sdom2bounds(new String(pair.fst));
     ...
     * @throws WCSException 
     */
    protected Pair<byte[], String> executeRasqlQuery(GetCoverageRequest request, 
